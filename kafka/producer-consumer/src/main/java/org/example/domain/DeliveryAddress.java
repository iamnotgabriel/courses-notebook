...
public class DeliveryAddress extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -1981802009446827856L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"DeliveryAddress\",\"namespace\":\"org.example.domain\",\"fields\":[{\"name\":\"AddressLine\",\"type\":[\"null\",\"string\"]},{\"name\":\"City\",\"type\":[\"null\",\"string\"]},{\"name\":\"State\",\"type\":[\"null\",\"string\"]},{\"name\":\"PinCode\",\"type\":[\"null\",\"string\"]},{\"name\":\"ContactNumber\",\"type\":[\"null\",\"string\"]}]}");
   ...
   */
  public static org.example.domain.DeliveryAddress.Builder newBuilder() {
    return new org.example.domain.DeliveryAddress.Builder();
  }
   ...
   * @return A new DeliveryAddress RecordBuilder
   */
  public static org.example.domain.DeliveryAddress.Builder newBuilder(org.example.domain.DeliveryAddress.Builder other) {
    return new org.example.domain.DeliveryAddress.Builder(other);
  }
   ...
   * @return A new DeliveryAddress RecordBuilder
   */
  public static org.example.domain.DeliveryAddress.Builder newBuilder(org.example.domain.DeliveryAddress other) {
    return new org.example.domain.DeliveryAddress.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<DeliveryAddress>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(org.example.domain.DeliveryAddress.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(org.example.domain.DeliveryAddress other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.AddressLine)) {
        this.AddressLine = data().deepCopy(fields()[0].schema(), other.AddressLine);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public org.example.domain.DeliveryAddress.Builder setAddressLine(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.example.domain.DeliveryAddress.Builder clearAddressLine() {
      AddressLine = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public org.example.domain.DeliveryAddress.Builder setCity(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.example.domain.DeliveryAddress.Builder clearCity() {
      City = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public org.example.domain.DeliveryAddress.Builder setState(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.example.domain.DeliveryAddress.Builder clearState() {
      State = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public org.example.domain.DeliveryAddress.Builder setPinCode(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.example.domain.DeliveryAddress.Builder clearPinCode() {
      PinCode = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public org.example.domain.DeliveryAddress.Builder setContactNumber(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.example.domain.DeliveryAddress.Builder clearContactNumber() {
      ContactNumber = null;
